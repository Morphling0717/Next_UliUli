...
export const DIVA_BUFF_POOL: GachaEntry[] = [
  ...
  { text: "🔥 {USER} 燃曲压轴！全队获得【燃曲压轴】，全属性大幅提升！", tag: SKILL_TAGS.BUFF, status: 'DIVA_FINAL_CHORUS', statBuff: { atk: 1.22, def: 1.22, spd: 1.22, agl: 1.22, mag: 1.22, res: 1.22, wis: 1.22 } },
];
...
export const VALORANT_POOL: GachaEntry[] = [
  ...
  { text: "📷 {USER} 零(Cypher)！这具尸体在哪？获取了 {TARGET} 的位置，使其【情报暴露】、防御下降！", tag: SKILL_TAGS.DEBUFF, status: 'VALO_CYPHER_REVEALED' },
  ...
  { text: "🌊 {USER} 海港(Harbor)！狂潮！召唤【海港水墙】阻挡伤害！", tag: SKILL_TAGS.BUFF, status: 'VALO_HARBOR_WALL', statBuff: { def: 1.25, res: 1.35 } },
...
export const SIGUA_BABY_SUPPORT_POOL: GachaEntry[] = [
  { text: "🍼 {USER} 递上「爱心奶瓶」！克蕾儿获得【爱心奶瓶】，全属性大幅提升！", tag: SKILL_TAGS.BUFF, status: 'BABY_LOVE_BOTTLE', statBuff: { atk: 1.18, def: 1.18, spd: 1.12, agl: 1.12, mag: 1.18, res: 1.18, wis: 1.12 } },
  ...
  { text: "👀 {USER} 帮忙「寻找弱点」！给 {TARGET} 标上【弱点标记】，防御和魔抗下降！", tag: SKILL_TAGS.DEBUFF, status: 'BABY_WEAKNESS_MARK' },
