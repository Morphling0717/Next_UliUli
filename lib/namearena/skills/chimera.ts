...
export const chimeraSkills: Record<string, SkillDefinition> = {
  ...
  chimera_reconstruct: {
    name: '再生·血肉重铸', tag: SKILL_TAGS.HEAL, mult: 3.0,
    dispelSpecs: [{ strength: 'strong', direction: 'negative' }],
    text: '☢️ {USER} 启动炉心，恢复了 {VAL} 点生命并进行一次强驱散！',
  },
  chimera_petrify: { name: '魔眼·石化凝视', tag: SKILL_TAGS.MAG, mult: 1.5, statusApplications: [{ identityId: 'STUN' }], text: '👁️ {USER} 凝视 {TARGET}，造成 {VAL} 伤害并使其石化！' },
  chimera_fortress: { name: '铁壁·绝对防御', tag: SKILL_TAGS.BUFF, statusApplications: [{ identityId: 'BKB', attribution: { effectSourceId: 'chimera_fortress' } }], text: '🛡️ {USER} 展开了叹息之墙，免疫后续控制！' },
  chimera_warp: { name: '神速·次元跃迁', tag: SKILL_TAGS.PHYS, mult: 2.0, statusApplications: [{ identityId: 'AIM' }], text: '🌌 {USER} 瞬间跃迁至 {TARGET} 背后，造成 {VAL} 必中伤害！' },
  chimera_plague: { name: '灾祸·终焉之毒', tag: SKILL_TAGS.MAG, mult: 1.0, statusApplications: [{ identityId: 'POISON' }], text: '☠️ {USER} 释放瘟疫，对 {TARGET} 造成 {VAL} 伤害并附加剧毒！' },
};
