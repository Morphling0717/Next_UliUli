...
const JOBS: Partial<Record<string, JobDefinition>> = {
  ...
  ARKNIGHTS_OP:   { name: '史尔特尔',  icon: '🔥', hp: 1.0, atk: 1.0, def: 1.0, spd: 1.0, agl: 1.0, mag: 1.0, res: 1.0, wis: 1.0, skills: ['surtr_flame_sword', 'surtr_molten_shadow', 'surtr_twilight'] },
  YUZU_PROPHET_PHASE_ONE: {
    name: '巴别塔的恶灵',
    icon: '🜲',
    hp: 1.0, atk: 1.0, def: 1.0, spd: 1.0, agl: 1.0, mag: 1.0, res: 1.0, wis: 1.0,
    skills: ['yuzu_prophet_wrong_time', 'yuzu_prophet_wrong_place', 'yuzu_prophet_shatter'],
  },
  YUZU_PROPHET_PHASE_TWO: {
    name: '预言家',
    icon: '🜲',
    hp: 1.0, atk: 1.0, def: 1.0, spd: 1.0, agl: 1.0, mag: 1.0, res: 1.0, wis: 1.0,
    skills: ['yuzu_prophet_originium_land', 'yuzu_prophet_understand_puruisaishi', 'yuzu_prophet_execute_originium_plan'],
  },
